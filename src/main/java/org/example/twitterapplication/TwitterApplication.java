...
public class TwitterApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        CSVGenerator.generateAndWriteObject(User.class, "src/main/resources/user.csv", 1000);
        CSVGenerator.generateAndWriteObject(PollOption.class, "src/main/resources/pollOption.csv", 1000);
        CSVGenerator.generateAndWriteObject(Poll.class, "src/main/resources/poll.csv", 1000);
        CSVGenerator.generateAndWriteObject(UserFollowings.class, "src/main/resources/userFollowings.csv", 1000);
        CSVGenerator.generateAndWriteObject(UserFollowers.class, "src/main/resources/userFollowers.csv", 1000);
        CSVGenerator.generateAndWriteObject(Tweet.class, "src/main/resources/tweet.csv", 1000);
        CSVGenerator.generateAndWriteObject(Reaction.class, "src/main/resources/reaction.csv", 1000);
        ...
        if (response.equals("yes")) {
            ...
            CSVReader.readObjectFromCsv("src/main/resources/userFollowings.csv");
            CSVReader.readObjectFromCsv("src/main/resources/userFollowers.csv");
