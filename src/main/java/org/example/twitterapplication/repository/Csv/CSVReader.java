...
public class CSVReader {
    ...
    static {
        ...
        mapOfHeaders.put(UserFollow.class, "target_user_id, user_id");
    ...
    public static <T> void addIntoDB(List<T> objects, Class<T> tClass) {
        ...
        } else if (tClass == UserFollow.class) {
            instance.userFollowRepository.saveAll((List<UserFollow>) objects);
            System.out.println("User Follow saved to the database.");
